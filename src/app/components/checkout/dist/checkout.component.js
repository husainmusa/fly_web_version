...
var CheckoutComponent = /** @class */ (function () {
    ...
    CheckoutComponent.prototype.ngAfterViewInit = function () {
        ...
        if (navigator.geolocation) {
            this.watchId = navigator.geolocation.watchPosition(function (res) {
    ...
    CheckoutComponent.prototype.onError = function (error) {
        window.alert("Please enable location" + error);
    };
    CheckoutComponent.prototype.showPosition = function (position) {
        this.latitude = position.coords.latitude;
        this.longitude = position.coords.longitude;
    };
    CheckoutComponent.prototype.geocodeLatLng = function (geocoder, map) {
        var _this = this;
    ...
    CheckoutComponent.prototype.getName = function () {
        return this.util.userInfo && this.util.userInfo.first_name ? this.util.userInfo.first_name + ' ' +
            this.util.userInfo.last_name : 'Flyvip';
    };
    ...
    CheckoutComponent.prototype.getCards = function () {
        ...
        this.api.httpGet('https://api.stripe.com/v1/customers/' + this.util.userInfo.stripe_key +
            '/sources?object=card', this.util.stripe).subscribe(function (cards) {
            console.log(cards);
            if (cards && cards.data) {
    ...
    CheckoutComponent.prototype.next = function () {
        ...
        if (this.selected === 1 && this.deliveryOption === 'home') {
            ...
            this.selected = 3;
            var selecte = this.myaddress.filter(function (x) { return x.id === _this.selectedAddress; });
            var item = selecte[0];
    ...
    CheckoutComponent.prototype.addAddOn = function (item, parent) {
        var _this = this;
        // this.parentId = id;
        // const param = {
        //   id: this.parentId
    ...
    CheckoutComponent.prototype.minusAddOn = function (item, parent) {
        var _this = this;
        // this.parentId = id;
        // const param = {
        //   id: this.parentId
    ...
    ], CheckoutComponent.prototype, "frame");
    __decorate([
        core_1.ViewChild('newAddress')
    ], CheckoutComponent.prototype, "newAddress");
    __decorate([
        core_1.ViewChild('paytabs')
    ], CheckoutComponent.prototype, "paytabs");
    __decorate([
        core_1.ViewChild('offersModal')
    ], CheckoutComponent.prototype, "offersModal");
    __decorate([
        core_1.ViewChild('map', { static: true })
    ], CheckoutComponent.prototype, "mapEle");
