...
exports.TopOffersComponent = void 0;
var core_1 = require("@angular/core");
var TopOffersComponent = /** @class */ (function () {
    function TopOffersComponent(api, util, cart, router) {
        this.api = api;
        this.util = util;
        this.cart = cart;
        this.router = router;
    ...
    TopOffersComponent.prototype.getOffers = function () {
        var _this = this;
        var param = {
            id: localStorage.getItem('city'),
            limit: this.limit * 12
        };
        this.api.post('products/getOffersList', param).subscribe(function (data) {
    ...
    TopOffersComponent.prototype.ngOnInit = function () {
    };
    TopOffersComponent.prototype.onChange = function (value) {
    ...
    TopOffersComponent.prototype.singleProduct = function (item) {
        console.log('-->', item);
        var param = {
            queryParams: {
                id: item.id
    ...
    TopOffersComponent.prototype.addToCart = function (item, index) {
        console.log(item);
        this.products[index].quantiy = 1;
        this.cart.addItem(item);
    };
    TopOffersComponent.prototype.add = function (product, index) {
        console.log(product);
    ...
    TopOffersComponent.prototype.remove = function (product, index) {
    ...
    TopOffersComponent.prototype.loadData = function () {
        this.limit = this.limit + 1;
        this.loaded = true;
        this.getOffers();
    };
    TopOffersComponent = __decorate([
        core_1.Component({
    ...
    return TopOffersComponent;
}());
exports.TopOffersComponent = TopOffersComponent;
