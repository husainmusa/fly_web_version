...
exports.TopStoreComponent = void 0;
/*
...
var TopStoreComponent = /** @class */ (function () {
    function TopStoreComponent(util, api, router, route) {
        var _this = this;
        this.util = util;
        this.api = api;
        this.router = router;
        ...
        this.stores = [];
        this.dummystores = [];
        this.newStores = false;
        this.dummystores = Array(30);
        this.route.queryParams.subscribe(function (data) {
            if (data.type == "new") {
                _this.newStores = true;
            }
        });
        this.getStore();
    }
    TopStoreComponent.prototype.ngOnInit = function () {
    };
    TopStoreComponent.prototype.getStore = function () {
        var _this = this;
        var param = {
        ...
        this.api.post('stores/getByCity', param).subscribe(function (stores) {
            ...
            if (stores && stores.status === 200 && stores.data && stores.data.length) {
                ...
                if (_this.newStores) {
                    _this.stores = _this.stores.sort(function (b, a) { return a.id - b.id; });
                }
    ...
    TopStoreComponent.prototype.isOpen = function (start, end) {
        var format = 'H:mm:ss';
    ...
    TopStoreComponent.prototype.openStore = function (item, type) {
    ...
    TopStoreComponent.prototype.getTime = function (time) {
        return moment(time, ['h:mm A']).format('hh:mm A');
    };
    TopStoreComponent = __decorate([
        core_1.Component({
...
exports.TopStoreComponent = TopStoreComponent;
