...
var UtilService = /** @class */ (function () {
    function UtilService(router, toasterService, ngxService) {
        this.router = router;
        ...
        this.cartBtn = new rxjs_1.Subject();
        this.popupRX = new rxjs_1.Subject();
    ...
    UtilService.prototype.publishPopup = function () {
        this.popupRX.next();
    };
    UtilService.prototype.getPopup = function () {
        return this.popupRX;
    };
    UtilService.prototype.publishCartBtn = function () {
        this.cartBtn.next();
    };
    UtilService.prototype.subscribeCartBtn = function () {
        return this.cartBtn;
    };
    UtilService.prototype.toast = function (type, title, msg) {
    ...
    UtilService.prototype.start = function () {
        this.ngxService.start();
    };
    UtilService.prototype.stop = function () {
